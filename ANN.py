...
class Ann(object):
    ...
    def neural_network(self):
        ...
        weights = np.random.randn(self.inputs + 1, self.hn)  # generate the first step of the weights randomly
        # + 1 is for the bias node

        weights = weights*cmath.sqrt(1/self.inputs)  # scale the weights with the variance
